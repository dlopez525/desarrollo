<?php include 'docs/editarUsuario_exe.php'; ?>
            ...
            <div class="clearfix"></div>
              ...
              <div class="col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="docs/actualizarUsuario.php" method="POST">
              ...
              <button class="btn btn-primary" type="reset">Reset</button>
                          <button type="submit" class="btn btn-success" name="actualizarUsuario_btn">Submit</button>
                        </div>
                      </div>
