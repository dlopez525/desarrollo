<?php
  ...
  $sql = "SELECT id_producto,producto,categoria,precio,imagen FROM productos WHERE categoria = 'snack'" ;
  ...
  <?php do { ?>
     <div class="productos__item">
                <div class="productos__item__img">
                    <img src="../views/img/productos/<?php echo $fila['imagen'];?>" alt="">
                </div>
                <div class="productos__item__details">
                    ...
                    <a href="models/cartS.php?id=<?php echo $fila['id_producto'];?>" class="productos__item__details__add"><i class="icon-ios-cart-outline"></i></a>
                </div>
            </div>
